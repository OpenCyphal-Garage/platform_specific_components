...
#if UAVCAN_STM32_NUTTX
        modifyreg32(STM32_RCC_APB1ENR1,  0, RCC_APB1ENR1_CAN1EN);
        modifyreg32(STM32_RCC_APB1RSTR1, 0, RCC_APB1RSTR1_CAN1RST);
        modifyreg32(STM32_RCC_APB1RSTR1, RCC_APB1RSTR1_CAN1RST, 0);
# if UAVCAN_STM32_NUM_IFACES > 1
        modifyreg32(STM32_RCC_APB1ENR1,  0, RCC_APB1ENR1_CAN2EN);
        modifyreg32(STM32_RCC_APB1RSTR1, 0, RCC_APB1RSTR1_CAN2RST);
        modifyreg32(STM32_RCC_APB1RSTR1, RCC_APB1RSTR1_CAN2RST, 0);
# endif
#else
